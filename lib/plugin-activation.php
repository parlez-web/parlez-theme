...
add_action( 'tgmpa_register', 'myboutique_register_required_plugins' );
 ...
 */
function myboutique_register_required_plugins() {
	/*
	 ...
	 */
	$config = array(
		'id'           => 'myboutique',                 // Unique ID for hashing notices for multiple instances of TGMPA.
